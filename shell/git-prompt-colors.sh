...
# If you change this file, run `git_prompt_reset` to update
override_git_prompt_colors() {
  ...
  GIT_PROMPT_UNTRACKED="${BrightBlack}…"    # the number of untracked files/dirs
  ...
  GIT_PROMPT_START_USER="${BoldBlue}${PathShort}${ResetColor}"
